...
- `@acdh-oeaw/eslint-config-vue`: recommended config for Vue.js projects
...
# additional configs
npm install -D @acdh-oeaw/eslint-config-vue
```
...
{
	"eslintConfig": {
		"extends": ["@acdh-oeaw/eslint-config", "@acdh-oeaw/eslint-config-vue"]
	}
}
```
